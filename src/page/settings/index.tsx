...
function Settings() {
    ...
    const columns= [
        ...
        },
        {
            ...
            render(value:string, record:any) {
                return <>
                    <Button size="small" type="primary" className="mr" onClick={()=>edit(record.menu,record.accountName)}>Edit Permissions</Button>
                    <Popconfirm
   ...
   return <div>
        <Card>
            <Row gutter={16}>
                <Col span={8}>
                    <Input name="accountName" value={formData.accountName} placeholder="Enter account name" onChange={handleChange} />
                </Col>
                <Col span={8}>
        ...
        <Row gutter={16} className="mt">
            <Col span={8} >
                ...
                <Card className="mt">
                    <Popconfirm
                        title="Operation Confirmation"
                        description={`Are you sure you want to modify permissions for user ${accountName}?`}
                        okText="Yes"
                        cancelText="No"
                        onConfirm={handle}
                    >
