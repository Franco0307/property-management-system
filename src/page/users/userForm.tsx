                ...
                <Row gutter={16}>
                    ...
                    <Col span={12}>
                        <Form.Item
                            label="Contact Phone"
                            name="tel"
                            rules={[{ required: true, message: "Contact phone cannot be empty" },{pattern:/^1[3-9]\d{9}$/,message:"Please enter a valid phone number"}]}
                        >
                            <Input/>
                        </Form.Item>
                    </Col>
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <Form.Item
                            ...
                            name="status"
                            rules={[{ required: true, message: "Operating status cannot be empty" }]}
                        >
                            <Radio.Group>
                                <Radio value="1">In Operation</Radio>
