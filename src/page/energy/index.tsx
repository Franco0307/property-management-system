...
const data=[
    ...
    {
        name:"Shanghai 123 Network Co., Ltd",
    ...
    },
    {
        ...
        building:"Times Financial Plaza-Room 803",
        elec:60,
        hot:25,
        c:17
    },
    {
        name:"Cloud Network Co., Ltd",
    ...
    {
        name:"Beijing Ounce Technology Co., Ltd",
...
function Energy() {
        ...
        series: [
            {
                ...
                data: [
                    ...
                    { value: 28, name: 'Equipment Left On' },
    ...
    return <div className="dashboard">
        ...
        <Row gutter={16} className="mt" >
            <Col span={12} >
                <Card title="Energy Consumption Ratio" style={{ height: "400px" }}>
